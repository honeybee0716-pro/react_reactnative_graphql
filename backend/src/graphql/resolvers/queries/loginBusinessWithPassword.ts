...
export const loginBusinessWithPasswordSchema = gql`
  scalar JSON
  ...
  type Query {
    loginBusinessWithPassword(input: loginUserWithPasswordInput): loginUserResponse!
  }
`;

const loginBusinessWithPassword = async (parent: null, args: any) => {
...
export default loginBusinessWithPassword;
