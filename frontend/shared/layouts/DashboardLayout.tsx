...
const DashboardLayout: React.FC = ({ children }) => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <Center marginLeft={{ base: '4', sm: '8' }} style={{marginRight:"10px"}}>
    ...
    placement={position == "auto" ? undefined : position} trigger={triggerProps => {
      return <Button  variant="solid" {...triggerProps} style={{backgroundColor:"none"}} >
               <Image
              w={{ base: '35px', sm: '12' }}
              h={{ base: '35px', sm: '12' }}
              borderRadius="full"
        ...
        <Menu.Item><Pressable onPress={handleSignOut}><Text>Sign Out</Text></Pressable></Menu.Item>
