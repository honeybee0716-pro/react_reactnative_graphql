        ...
        >
          ...
          <Box flex='1'>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <Box>
                        <Pressable
                          borderWidth='1' borderColor={theme.colors.shared.soft4Gray} borderRadius='md' p={{ base: '6px', sm: '0.3rem' }}
                          _hover={{
                    ...
                    >
                      {[...Array(3)].map((_, i) => (
                        <Pressable key={i} backgroundColor={theme.colors.shared.black_6} borderRadius='full'>
                          <Text fontSize='sm' fontWeight='medium' paddingX='4' paddingY='1'>
                            30,000
                          </Text>
                        </Pressable>
                      ))}
                    </HStack>
                    <Slider marginTop='5' w="full" defaultValue={70} minValue={0} maxValue={100} accessibilityLabel="hello world" step={1}>
                      <Slider.Track>
                        <Slider.FilledTrack backgroundColor={theme.colors.shared.brightBlue} />
                      </Slider.Track>
                      <Slider.Thumb backgroundColor={theme.colors.shared.softer4Gray} />
                    </Slider>
                    <Box
                      flexDirection='row'
            ...
            >
                    ...
                    >
                      ...
                      <Box w='13%'>
                        ...
                        >
                          <Box>
                            <Pressable
                              backgroundColor='white' borderWidth='1' borderColor={theme.colors.shared.soft4Gray} borderRadius='md' p={{ base: '6px', sm: '0.3rem' }}
                              _hover={{
                                backgroundColor: theme.colors.shared.softerGray,
                              }}
                            >
              ...
              <HStack alignItems='center' justifyContent='space-between' marginTop={{ base: '4', sm: '5' }}>
                <Box>
                  <Text
                    fontWeight='medium'
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Pressable borderWidth='1' borderColor={theme.colors.shared.soft4Gray} borderRadius='md' p={{ base: '6px', sm: '0.3rem' }}>
                    <Box w='16px'>
                      <IconMoreVertical />
                    </Box>
                  </Pressable>
                ...
                <Box
                  marginTop='5'
                >
                  <Swiper pagination={true} modules={[Pagination]} style={{ width: '100%', height: '100%' }} spaceBetween={10}>
                    {[...Array(3)].map((_, i) => (
                      <SwiperSlide key={i}>
                        <Box
                          position='relative'
