          ...
          <Box flex='1'>
            ...
            >
              ...
              >
                ...
                <Hidden from='sm'>
                  <Pressable
                    backgroundColor='white' borderWidth='1' borderColor={theme.colors.shared.soft4Gray} borderRadius='md' p={{ base: '5px', sm: '0.3rem' }}
                    _hover={{
              ...
              >
                ...
                <Box
                  borderRadius='2xl'
                  backgroundColor={{ base: 'transparent', lg: theme.colors.shared.lightAliceBlue }}
              ...
              >
                ...
                <Pressable
                  backgroundColor={{ base: 'white', sm: theme.colors.shared.aliceBlue }}
                  borderWidth='1'
                  borderColor={{ base: 'gray.300', sm: theme.colors.shared.softGray }}
                  borderRadius='lg'
                  w='40'
                  paddingY='2'
                  _hover={{
              ...
              >
                ...
                <VStack marginTop='4' space='4'>
                  ...
                  >
                    ...
                    <Pressable
                      backgroundColor='white'
                      borderWidth='1' borderColor={theme.colors.shared.softer3Gray}
                      borderRadius='lg'
                      paddingY='0.3rem'
                      paddingX='0.35rem'
                      _hover={{
              ...
              >
                ...
                <VStack marginTop='4' space='4'>
                  <HStack
                    ...
                    paddingY='2'
                  >
                    <Center w='32px' h='32px' borderRadius='xl' backgroundColor='#1877F2'>
                      <Box w='16px'>
                  ...
                  <HStack
                    ...
                    paddingY='2'
                  >
                    <Center w='32px' h='32px' borderRadius='xl' backgroundColor='#1DA1F2'>
                      <Box w='16px'>
                        <IconTwitterWhite />
                      </Box>
                    </Center>
                  ...
                  <HStack
                    ...
                    paddingY='2'
                  >
                    <Center w='32px' h='32px' borderRadius='xl' backgroundColor='#F00073'>
                      <Box w='16px'>
                        <IconInstagramWhite />
                      </Box>
                    </Center>
