      ...
      <DashboardLayout>
        <Box flexDirection={{ lg: 'row' }}>
          ...
          <Box width={{ lg: '430px' }}>
            ...
            >
              ...
              <Box flexDirection={{ base: 'none', sm: 'row', lg: 'none' }}>
                <Box
        ...
        <Box>
          ...
          >
            ...
            <Hidden till="sm">
              <KeyboardAwareScrollView horizontal={true} overScrollMode="auto">
                <HStack space="10">
                  {[...Array(8)].map((_, i) => (
                    <Box key={i} w="300px">
                      <Box w="300px" h="160px">
                        <Image
                          borderRadius="xl"
                          flex="1"
                          source={require('shared/images/Tutorial - Creating a list.png')}
                        />
                      </Box>
              ...
              <VStack space="3">
                {[...Array(2)].map((_, i) => (
                  ...
                  >
                    ...
                    <Box flex="1" flexDirection="row" marginLeft="3">
                      <Text>How to add a new list</Text>
                    </Box>
                    <Pressable
                      borderColor={theme.colors.shared.soft4Gray}
                      borderWidth="1"
