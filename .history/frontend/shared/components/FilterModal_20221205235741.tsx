...
var Sname: any, Fname: any, Lname: any, Cname, Ename, Search
const FilterModal = ({ modalIsOpen, setModalIsOpen }: any) => {
  ...
  const hasFilters = !!firstName || !!lastName || !!companyName || !!email
            ...
            <Box flexDirection="row" justifyContent="space-between">
              ...
              <Box flex="1" position="relative" marginBottom="3" marginLeft="2">
                <Input
                  ...
                  placeholder="Email"
                  onChangeText={(text) =>
                    setEmail(text.length ? text : undefined)
                  }
                  value={email}
                />
              </Box>
...
export { FilterModal, Sname, Fname, Lname, Cname, Ename, Search }
