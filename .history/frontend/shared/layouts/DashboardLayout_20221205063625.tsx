...
const DashboardLayout: React.FC = ({ children }) => {
  ...
  const [pageTitle, setPageTitle] = useRecoilState<any>(pageTitleState)
  ...
  React.useEffect(() => {
    if (userLogoData !== undefined) setDisplayCompanyLogo(userLogoData.image)
  }, [userLogoData])
      ...
      >
            ...
            <Box flexDir="row" alignItems="center" w="full">
              <img
                ...
                src={
                  displayCompanyLogo !== ''
                    ? displayCompanyLogo
                    : require('shared/images/salespinLogo.png')
                }
              />
              <Text
        ...
        {control === 'customer' && (
          ...
          >
            <Center>
              <Text
                style={{ color: 'white', fontSize: '18px', marginTop: '4px' }}
              >
                {points}
              </Text>
            </Center>
